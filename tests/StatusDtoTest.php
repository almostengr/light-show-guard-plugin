...
use \App\ShowPulseStatusRequestDto;
...
final class StatusDtoTest extends TestCase
{
    ...
    {
        $dto = new ShowPulseStatusRequestDto(4, "test.fseq", "test.mp3", 1, 5);
        $this->assertEquals("test.fseq", $dto->sequence_filename);
    }

    public function testConstructorWithSpecialCharacterSequence()
    {
        $dto = new ShowPulseStatusRequestDto(0, 'test-flight_rainbow.fseq', "test-flight_rainbow.mp3", 1, 5);
    ...
    {
        $dto = new ShowPulseStatusRequestDto(5, 'testing.fseq', 'testing.mp3', 0, 5);
    ...
    {
        $dto = new ShowPulseStatusRequestDto(0, "test.fseq", 'test.mp3', 1, 5);
